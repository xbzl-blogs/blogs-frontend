 ...
 * 功能：全部类型详情页面
 *
 * 详情页面先引入allContents页面在由此页面分配各类型展示
 *
 *
 */
...
var $ = require('jquery');
var StandardContent = require('./StandardContent');
        ...
        return(
            <div className="s-content content">
                <main className="row content__page">
                    ...
                    {this.state.type === 1
                        ? <StandardContent data={this.state.data}/>
                        : <h1 className="display-1">404！！！此贴已被删除详情，只剩下各标题啦.</h1>}
